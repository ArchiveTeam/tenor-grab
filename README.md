...
More information about the archiving project can be found on the ArchiveTeam wiki: [Tenor](https://wiki.archiveteam.org/index.php?title=Tenor)
...
We strongly encourage you to join the IRC channel associated with this project in order to be informed about project updates and other important announcements, as well as to be reachable in the event of an issue. The Archive Team Wiki has [more information about IRC](https://wiki.archiveteam.org/index.php/Archiveteam:IRC). We can be found at hackint IRC [#losttenure](https://chat.hackint.org/?join=%23losttenure).
...
after which the project container can be run:
    ...
    docker run -d --name archiveteam --label=com.centurylinklabs.watchtower.enable=true --log-driver json-file --log-opt max-size=50m --restart=unless-stopped atdr.meo.ws/archiveteam/tenor-grab --concurrent 1 YOURNICKHERE
...
Have an issue not listed here? Join us on IRC and ask! We can be found at hackint IRC [#losttenure](https://chat.hackint.org/?join=%23losttenure).
